"""Link clinical TB case IDs to person tracking data.

Merges linked track IDs with clinical records by matching clinic visit order
per date. Reads from data-clean/clinical/tb_cases.csv, data-clean/tracking/linked/,
and data-clean/tracking/linked-tb/. Writes to data-clean/tracking/linked-clinical/.
"""
